 ...
 * @returns Parsed ApiResponse or null if all bases fail/return non-2xx. JSON parse errors
 *          log a warning and return null immediately (no further fallback attempts).
 */
